...
import { Search, Globe, Menu, User, Heart, Plus, LogOut } from 'lucide-react'
      ...
      <div className="max-w-[1760px] mx-auto px-6 md:px-10 xl:px-20">
        <div className="flex items-center justify-between h-20">
          ...
          >
            ...
            <span className="text-sm text-muted px-4">Add guests</span>
          ...
          >
            ...
            <div className="text-left">
              <p className="text-xs font-semibold">Anywhere</p>
              <p className="text-xs text-muted">Any week · Add guests</p>
            </div>
          </button>
